    ...
    public class ContentDao
    {
        ...
        public bool Edit(Content content)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(content.MetaTitle))
                {
                    cont.MetaTitle = StringHelper.ToUnsignString(content.Name);
                }else {
                ...
                cont.MetaDescriptions = content.MetaDescriptions;
